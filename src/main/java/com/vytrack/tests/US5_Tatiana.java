...
public class US5_Tatiana extends TestBase {
    ...
    public void verify_columns_as_sales_manager(){
        ...
        //we are using for waiting until loader mask disappears
        VytrackUtils.waitTillLoaderMaskDisappear();
        vehiclesModelBtn.click();
        VytrackUtils.waitTillLoaderMaskDisappear();

        List<String> actualHeaderFromVehiclesModelTable = WebTableUtils.getHeadersFromVehicleModelTable();
        List<String> expectedHeaderFromVehiclesModelTable = new ArrayList<>(Arrays.asList(
                "MODEL NAME",
                "MAKE",
                "CAN BE REQUESTED",
                "CVVI",
        ...
        Assert.assertEquals(actualHeaderFromVehiclesModelTable,expectedHeaderFromVehiclesModelTable);
    }
}
